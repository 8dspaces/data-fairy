...
import {PACKAGE_STRING}.enums.{ENUM_CLASS_NAME};
...
class {CLASS_NAME} implements IDBVOTable
{
	...
	public function index(type:{ENUM_CLASS_NAME}, row:IDBVORow):IDBVORow
	{
		row.dbvos = dbvos;
	...
	public function getRowByType(type:{ENUM_CLASS_NAME}):{ROW_CLASS_NAME}
	{
		// TODO: Figure out a way to use enums to store and lookup values
		return null;
	}
}
